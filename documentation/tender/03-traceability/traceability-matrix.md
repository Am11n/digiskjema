...
| REQ-B1-0014 | Bilag 1 / tabell 6 / rad 5 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-BRANDING-001, PR-19 | visual testing + Component implementation | done | Branding and layout customization - Templates |
| REQ-B1-0015 | Bilag 1 / tabell 6 / rad 6 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | FEAT-COMPONENTS-001, PR-20 | component testing + Component implementation | done | Shared/restricted components - Libraries |
| REQ-B1-0016 | Bilag 1 / tabell 6 / rad 7 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-TEMPLATES-002, PR-21 | library validation + Component implementation | done | Multi-tenant form library - Templates |
...
| REQ-B1-0030 | Bilag 1 / tabell 7 / rad 14 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#6.1 | FEAT-FORMAT-001, PR-22 | functional testing + Component implementation | done | Alternative form formats - Accessibility |
| REQ-B1-0031 | Bilag 1 / tabell 7 / rad 15 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | PR-23 | data migration testing + Component implementation | done | Form import/export - Admin |
...
| REQ-B1-0036 | Bilag 1 / tabell 7 / rad 20 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-PERFORMANCE-001, PR-24 | load testing + Component implementation | done | Large scale form handling - Form Engine |
...
| REQ-B1-0038 | Bilag 1 / tabell 7 / rad 22 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | PR-25 | search functionality testing + Component implementation | done | Form categorization and search - Admin |
| REQ-B1-0039 | Bilag 1 / tabell 7 / rad 23 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | PR-26 | distribution testing + Component implementation | done | User list management - Admin |
...
| REQ-B1-0042 | Bilag 1 / tabell 7 / rad 26 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | PR-27 | export format testing + Component implementation | done | Data export to file systems - Admin |
| REQ-B1-0043 | Bilag 1 / tabell 7 / rad 27 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#4.2 | PR-28 | integration testing + Component implementation | done | File system delivery - Integration |
| REQ-B1-0044 | Bilag 1 / tabell 7 / rad 28 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | PR-29 | data source testing + Component implementation | done | Internal data sources - Form Logic |
...
| REQ-B1-0046 | Bilag 1 / tabell 7 / rad 30 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | PR-30 | categorization testing + Component implementation | done | Form categorization - Admin |
