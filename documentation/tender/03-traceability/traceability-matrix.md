...
| REQ-B1-0003 | Bilag 1 / tabell 4 / rad 1 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#6.1 | FEAT-UI-CUSTOM-001 | a11y testing + Supplier response | in-progress | User interface customization - Accessibility |
...
| REQ-B1-0006 | Bilag 1 / tabell 4 / rad 4 | A | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#6.1 | FEAT-I18N-001 | linguistic review | in-progress | Norwegian language requirement - Localization |
| REQ-B1-0007 | Bilag 1 / tabell 4 / rad 5 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#6.1 | FEAT-A11Y-001 | WCAG audit + automated testing | in-progress | Universal design compliance - Accessibility |
| REQ-B1-0008 | Bilag 1 / tabell 4 / rad 6 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#6.1 | FEAT-I18N-002 | translation workflow testing | in-progress | Multilingual form support - Translation |
...
| REQ-B1-0010 | Bilag 1 / tabell 6 / rad 1 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-MULTITENANT-001 | integration testing + Supplier response | in-progress | Single/multi-municipality forms - Multi-tenant |
...
| REQ-B1-0029 | Bilag 1 / tabell 7 / rad 13 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | FEAT-FEEDBACK-001 | functional testing | in-progress | User feedback collection - Admin |
...
| REQ-B1-0032 | Bilag 1 / tabell 7 / rad 16 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-FIELDTYPES-001 | functional testing | in-progress | Field types and configuration - Form Engine |
| REQ-B1-0033 | Bilag 1 / tabell 7 / rad 17 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | FEAT-VALIDATION-001 | validation testing | in-progress | Data validation rules - Form Logic |
| REQ-B1-0034 | Bilag 1 / tabell 7 / rad 18 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | FEAT-CONDITIONAL-001 | logic testing | in-progress | Conditional field display - Form Logic |
| REQ-B1-0035 | Bilag 1 / tabell 7 / rad 19 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-TEMPLATES-001 | template management testing | in-progress | Form template management - Form Engine |
...
| REQ-B1-0037 | Bilag 1 / tabell 7 / rad 21 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-PREVIEW-001 | functional testing | in-progress | Form preview capability - Form Engine |
...
| REQ-B1-0040 | Bilag 1 / tabell 7 / rad 24 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.1 | FEAT-LAYOUT-001 | visual testing | in-progress | Custom form layout - Form Engine |
| REQ-B1-0041 | Bilag 1 / tabell 7 / rad 25 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | FEAT-SCRIPTING-001 | script validation testing | in-progress | Custom scripting support - Form Logic |
...
| REQ-B1-0045 | Bilag 1 / tabell 7 / rad 29 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#2.2 | FEAT-COMPONENTS-002 | component reuse testing | in-progress | Field group reuse - Form Logic |
...
| REQ-B1-0050 | Bilag 1 / tabell 10 / rad 1 | AV | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | FEAT-ANALYTICS-001 | reporting testing | in-progress | Form usage statistics - Admin |
| REQ-B1-0051 | Bilag 1 / tabell 10 / rad 2 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | FEAT-EXPORT-001 | export testing | in-progress | Statistics export - Admin |
| REQ-B1-0052 | Bilag 1 / tabell 10 / rad 3 | V | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | FEAT-ADMIN-001 | admin interface testing | in-progress | Admin reporting environment - Admin |
...
| REQ-B1-0102 | Bilag 1 / tabell 25 / rad 2 | A | agent-os/specs/tender-baseline-plan/spec.md | agent-os/specs/tender-baseline-plan/tasks.md#5.1 | FEAT-I18N-003 | language capability confirmation | in-progress | Norwegian support - Admin |
